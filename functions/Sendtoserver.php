...
function GuiMail($clien_email, $nguoidung, $nd_mail, $td)
{
    ...
    try {
        ...
        $mail->setFrom($clien_email, $nguoidung . ' : ' . $clien_email); // địa chỉ mail của người gủi và tên người gủi
        $mail->addAddress('mainichichimvm@gmail.com', 'server'); //mail và tên người nhận  có thể để nhiều
        ...
        $mail->smtpConnect(
            array(
                // gủi mail từ local nên phải có cái này
                "ssl" => array(
                    "verify_peer" => false,
