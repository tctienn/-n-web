        ...
        if ($result->num_rows != 0) {
            {   $errorMsg=''; 
                ...
                if ($row["is_admin"]==1) {
                    ...
                    header("Location: ./admin/template/index_admin.php");
                } 
                else
                {
                    ...
                    <div id="login-box" style='background-color: #ffffffcc; border-radius: 10px; margin-top:40px' class="col-md-12">
                        <form id="login-form" class="form" action="./login.php?action=login" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control" autocomplete="off"   placeholder="mật khẩus " required >
                            </div>
                            <div class="form-group">
